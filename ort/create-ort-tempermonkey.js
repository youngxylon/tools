...
;(function () {
  ...
  document.getElementsByClassName('tbhead')[0].firstElementChild.appendChild(createBtn)
  ...
  createBtn.onclick = function toCreateLog() {
    ...
    document.getElementById('xhe0_iframe').contentWindow.document.getElementById('sourceCode').value = log.createLog()
